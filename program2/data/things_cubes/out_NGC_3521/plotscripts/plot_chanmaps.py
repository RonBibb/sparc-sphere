...
image = fits.open('NGC_3521_RO_CUBE_THINGS.FITS') 
...
for k in range (len(files_mod)): 
  ...
  for j in range (0,3): 
    for i in range (0,5): 
      ...
      velo_kms = (chan+1--1)*-5.19365+1085.01
      ...
      if (j==i==0): 
        ...
        bmaj, bmin, bpa = 5.46144/float(xmax-xmin), 4.27152/float(ymax-ymin),-70.23
