...
set output 'out_NGC_3521/NGC3521H_rc_inc_pa.eps'
unset key
set size 0.60, 1
...
@TMARGIN
@NOXTICS
set yrange [-5:1412.77]
set ylabel 'V_c  [km/s]'
set ytics 50
set mytics 5
plot 'out_NGC_3521/rings_final1.txt' u 2:3 w lp ls 1, 'out_NGC_3521/rings_final2.txt' u 2:3 w lp ls 2
set title ''
@MMARGIN
@NOXTICS
set yrange [65.43:79.97]
set ylabel 'i [deg]'
set ytics 5
set mytics 5
plot 'out_NGC_3521/rings_final1.txt' u 2:5 w lp ls 1, 'out_NGC_3521/rings_final2.txt' u 2:5 w lp ls 2
@BMARGIN
@XTICS
set xlabel 'Radius [arcsec]'
set yrange [14.7748:391.252]
set ylabel 'P.A. [deg]'
set ytics 5
set mytics 5
plot 'out_NGC_3521/rings_final1.txt' u 2:6 w lp ls 1, 'out_NGC_3521/rings_final2.txt' u 2:6 w lp ls 2
unset multiplot
set output 'out_NGC_3521/NGC3521H_disp_vsys_z0.eps'
unset key
set xlabel 'Radius [arcsec]'
set xtics 200
set mxtics 2
...
@TMARGIN
@NOXTICS
set yrange [0:13.3341]
set ylabel '{/Symbol s} [km/s]'
set ytics 5
set mytics 5
plot 'out_NGC_3521/rings_final1.txt' u 2:4 w lp ls 1, 'out_NGC_3521/rings_final2.txt' u 2:4 w lp ls 2
@MMARGIN
@NOXTICS
set yrange [713.15:893.85]
set ylabel 'V_{sys} [km/s]'
plot 'out_NGC_3521/rings_final1.txt' u 2:12 w lp ls 1, 'out_NGC_3521/rings_final2.txt' u 2:12 w lp ls 2
@BMARGIN
@XTICS
set xlabel 'Radius [arcsec]'
set yrange [9:11]
set ylabel 'Scale height [arcsec]'
plot 'out_NGC_3521/rings_final1.txt'u 2:8 w lp ls 1, 'out_NGC_3521/rings_final2.txt' u 2:8 w lp ls 2
unset multiplot
set output 'out_NGC_3521/NGC3521H_xc_yc_cd.eps'
set multiplot layout 3,1 rowsfirst
@LABELF
@TICSF
@TMARGIN
@NOXTICS
set yrange [454.5:555.5]
set ylabel 'X_c [pix]'
plot 'out_NGC_3521/rings_final1.txt' u 2:10 w lp ls 1, 'out_NGC_3521/rings_final2.txt' u 2:10 w lp ls 2
@MMARGIN
@NOXTICS
set yrange [464.31:567.49]
set ylabel 'Y_c [pix]'
plot 'out_NGC_3521/rings_final1.txt' u 2:11 w lp ls 1, 'out_NGC_3521/rings_final2.txt' u 2:11 w lp ls 2
