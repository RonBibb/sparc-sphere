...
gname = 'ngc2403' 
outfolder = '/Users/ronbibb/Library/CloudStorage/OneDrive-Personal(2)/Documents/Academic/halo-spheres/program2/data/barolo_examples/examples/output/ngc2403/' 
outprefix = 'ngc2403' 
twostage = 1 
plotmask = 0 
zmin, zmax = 0, 61
...
xminpv, xmaxpv = np.floor(crpixpv-1-84), np.ceil(crpixpv-1 +84) 
...
zmin_wcs, zmax_wcs = 292.187, -27.2899
cont = 0.00138475
